...
import dev.putra.libraries.picker.provider.CameraProvider
import dev.putra.libraries.picker.provider.CompressionProvider
import dev.putra.libraries.picker.provider.CropProvider
import dev.putra.libraries.picker.provider.GalleryProvider
import java.io.File
...
class ImagePickerActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        internal fun getCancelledIntent(context: Context): Intent {
            val intent = Intent()
            val message = context.getString(R.string.picker_error_task_cancelled)
    ...
    private fun loadBundle(savedInstanceState: Bundle?) {
        ...
        when (provider) {
            ...
            ImageProvider.CAMERA -> {
                ...
                setError(getString(R.string.picker_error_task_cancelled))
            }
        }
    }
