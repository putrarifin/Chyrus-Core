...
import dev.putra.libraries.picker.util.IntentUtils
import dev.putra.libraries.picker.util.PermissionUtil
import dev.putra.libraries.picker.util.PermissionUtil.isPermissionGranted
import java.io.File
...
class CameraProvider(activity: ImagePickerActivity) : BaseProvider(activity) {
    ...
    private fun startCameraIntent() {
        ...
        if (file != null && file.exists()) {
            ...
            setError(R.string.picker_error_failed_to_create_camera_image_file)
        }
    }
        ...
        if (requestCode == PERMISSION_INTENT_REQ_CODE) {
            ...
            if (isPermissionGranted(this)) {
                ...
                val errorRes = if (mAskCameraPermission) {
                    R.string.picker_permission_camera_extended_denied
                } else {
                    R.string.picker_permission_camera_denied
                }
