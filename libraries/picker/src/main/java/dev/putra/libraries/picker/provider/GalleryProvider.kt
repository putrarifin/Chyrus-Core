...
import dev.putra.libraries.picker.util.FileUriUtils
    ...
    fun onRequestPermissionsResult(requestCode: Int) {
        if (requestCode == PERMISSION_INTENT_REQ_CODE) {
            ...
            if (PermissionUtil.isPermissionGranted(this, REQUIRED_PERMISSIONS)) {
                ...
                setError(getString(R.string.picker_permission_gallery_denied))
            }
        }
    }
    ...
    private fun handleResult(data: Intent?) {
        ...
        if (uri != null) {
            ...
            if (!filePath.isNullOrEmpty()) {
                ...
                setError(R.string.picker_error_failed_pick_gallery_image)
            }
        } else {
            setError(R.string.picker_error_failed_pick_gallery_image)
        }
